...
function updateBotDeveloperPanel() {
  ...
  const lines = [
    `Cube Reversi Bot Developer Summary — Version 1.32.3`,
    `Board: ${boardLabel}`,
...
function updateVersionLabel() {
  ...
  versionLabel.innerHTML = `<span class="version-number">Version 1.32.3</span><span class="version-separator"> · </span><span class="version-board-size">${boardSizeText}</span>`;
  document.title = `Cube Reversi — 1.32.3`;
